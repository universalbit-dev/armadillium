...
Description:
Create floating ip and webserver (nginx)

[WebServer Directory Permissions](https://)
...
[PaceMaker](https://packages.debian.org/sid/pacemaker):
...
allow nodes host 
enable corosync,pacemaker and pcs ports:
